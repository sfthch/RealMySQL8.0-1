...
6.2.1 압축 테이블 생성
  ...
  두 번째 테이블 생성 구문에서 와같이 ROW_FORMAT 옵션이 생략되면 자동으로 ROW_FORMAT=COMPRESSED 옵션이 추가되어 생성된다.
...
6.2.2 KEY_BLOCK_SIZE 결정
  ...
  위 예제의 마지막 부분을 보면 압축된 테이블의 PRIMARY 키는 전체 18653번 압축을 실행했는데, 그중에서 13478번 성공했다.
